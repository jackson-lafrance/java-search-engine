...
//yourResult = tester.search("lime cherry orange orange", true, 10);
//TestingTools.checkSearch(yourResult, "lime cherry orange orange",true, passOut, failOut, "TinyFruitsSearchBoostTester", "Test #389 checking search results for lime cherry orange orange with boost=true");
        ...
        while (line != null) {
            ...
            boolean processResult = correctPhrase;
